...
public class Six_Booking_Conformation {
  @Test
  ...
  public void beforeClass() {
      ...
      WebElement selectButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(@id, 'ControlGroupSelectView_AvailabilityInputSelectView')][1]")));
      ...
      WebElement continueButton = driver.findElement(By.id("CONTROLGROUPPASSENGER_PassengerInputViewPassengerView_ButtonSubmit"));
